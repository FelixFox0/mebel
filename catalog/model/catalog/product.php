...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'additional_description'      => $query->row['additional_description'],
				'delivery_description'      => $query->row['delivery_description'],
		...
		if (isset($data['sort']) && in_array($data['sort'], $sort_data)) {
			if ($data['sort'] == 'pd.name' || $data['sort'] == 'p.model') {
				$sql .= " ORDER BY LCASE(" . $data['sort'] . ")";
                        } elseif ($data['sort'] == 'p.new') {       
                                $sql .= " ORDER BY " . $data['date_added'];
	...
	public function getProductOptions($product_id, $show_in_cart = false) {
