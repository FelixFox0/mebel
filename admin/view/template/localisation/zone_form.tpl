    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-zone" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-additional">Дополнительный</label>
            <div class="col-sm-10">
              <input type="checkbox" name="additional" value="1" <?php if($additional): ?> checked <?php endif; ?> placeholder="Основной" id="input-additional" class="form-control" />
            </div>
          </div>
        </form>
      </div>
